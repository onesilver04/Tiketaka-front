                    ...
                    {showStationSelector && (
                        <div ref={dropdownRef} style={{
                            ...
                            <StationSelector
                                ...
                                onSelect={(station) => {
                                    handleStationChange(showStationSelector, station);
                                    setShowStationSelector(null);
                                }}
                            />
                        </div>
