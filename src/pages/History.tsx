        ...
        <div className={styleb.box}>
            ...
            <div className="date-section">
                ...
                <span className="period">
                    <span
                        className={`clickable ${selectingDate === "start" ? "active" : ""}`}
                    ...
                    ~{" "}
                    <span
                        className={`clickable ${selectingDate === "end" ? "active" : ""}`}
                    ...
                    onChange={(value) => {
                        if (value instanceof Date) {
                            if (selectingDate === "start") {
                                ...
                                const newEnd = value < startDate ? startDate : value;
                                setEndDate(newEnd);
                            }
                        }
                    }}
            ...
            <button className={`${styles.button} history-look-up`} onClick={handleSearch}>
                조회
            </button>
                            ...
                            <label className="selection-header-right">
                                <input
                                    ...
                                    checked={
                                        ...
                                        selected.length === filteredReservations.length
                                    }
                                    onChange={(e) => {
                                        setSelected(
                                            e.target.checked
