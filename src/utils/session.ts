...
// // Get the current session logs - for LLM
// export const getLatestSessionLogs = (): {
//     sessionId: string;
//     purpose: string;
//     location: string;
...
//                 const sessionList = JSON.parse(localStorage.getItem(HISTORY_SESSIONS_KEY) || "[]");
//                 const index = sessionList.findIndex((s: any) => s.sessionId === prevSession.sessionId);
//                 if (index !== -1) {
//                     sessionList[index] = prevSession;
//                 } else {
//                     sessionList.push(prevSession);
...
//     const sessionList = JSON.parse(localStorage.getItem(RESERVATION_LOG_SESSIONS_KEY) || "[]");
//     sessionList.push(newSession);
